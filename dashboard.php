  ...
  <aside class="sidebar">
    <div class="sidebar-header">
      <div class="sidebar-logo">
        <svg viewBox="0 0 24 24"><path d="M19 3H5C3.89 3 3 3.89 3 5v14c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2V5c0-1.11-.89-2-2-2zm-6 9h-2v2H9v-2H7v-2h2V8h2v2h2v2z"/></svg>
      </div>
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <div id="view-inicio" class="view-section">
        ...
        <div class="card">
          <div class="card-header"><h3>Últimas ventas del día</h3></div>
